        ...
        >
          ...
          <template v-slot:append>
            ...
            v-if="existingfile"
              ...
              dense
              icon="cancel"
              @click.stop.prevent="clearFileAndResetTable"
            />
          </template>
        </q-file>
      </div>
      ...
      >
        <q-td :props="props">
          ...
          <div v-if="col.name === 'status'">
            ...
            <q-chip
              v-else-if="props.row[col.field] === 'Overdue'"
              color="red"
              text-color="white"
              dense
            >
